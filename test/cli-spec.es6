...
`
  ...
  it('attrconv [inputPath] -t [html] -o [path]', (done) => {
  ...
  it('attrconv [inputPath] --patterns-text [text] -o [path]', (done) => {
  ...
  it('attrconv [inputPath] -p [path] -o [path]', (done) => {
  ...
  it('attrconv -t [html] -o [path]', (done) => {
  ...
  it('attrconv -t [html] --patterns-text [text] -o [path]', (done) => {
  ...
  it('attrconv -t [html] -p [path] -o [path]', (done) => {
